package com.rentranslate.app.modules.rentersplace.`data`.model

import com.rentranslate.app.R
import com.rentranslate.app.appcomponents.di.MyApp
import kotlin.String

data class RenterSPlaceModel(
  /**
   * TODO Replace with dynamic value
   */
  var txtPlace: String? = MyApp.getInstance().resources.getString(R.string.lbl_place)
  ,
  /**
   * TODO Replace with dynamic value
   */
